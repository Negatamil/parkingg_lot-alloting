      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow p-4 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-blue-500">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">Manage user accounts & roles</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-green-500">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">Manage parking slots</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-purple-500">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              <p className="font-semibold text-gray-900">Smart Features</p>
              <p className="text-sm text-gray-600">AI & automation</p>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-lg shadow p-4 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-orange-500">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
              <span className="text-orange-600 text-xl">📊</span>
            </div>
            <div className="text-left">
              <p className="font-semibold text-gray-900">System Monitor</p>
